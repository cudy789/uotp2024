// 
//   This is a template that you will modify to make the robot follow a black line on the ground! 
//   If the robot sees a line on the left, it should turn left. If it sees a line on the right, it should 
...
void loop() {
  ...
  // Driving code: add your code here!
  // ====================== PART 1 ======================
  //   Make your robot drive in a square! Don't worry about detecting the line yet
  //   Call the rover_stop, rover_straight, rover_left, and rover_right functions to make
  //   it move. Add your code here.




  // ====================== PART 2 ======================
  // Comment out your code from part 1 so it doesn't run. Now, use the IR sensors 
  // to make the robot follow the line! If the left IR sensor is true and the right IR sensor is false, 
  // then turn the rover right. If the left IR sensor is false and the right IR sensor is true, turn the 
  // rover left. Else, drive the rover straight.
